...
> actuels. **Ouvert le 2026-08-12. 15 planches publiées sur 23.**
>
...
|---|---|---|
| `sankey-energie` | 2 — deux mécanismes : le flux à largeur proportionnelle (École des douanes) et `plafonds` (la proportion sans flux — trois pistes à échelle commune, le plafond carbone qui tombe au tiers à la frontière réglementaire et commande le générateur, logements Maubec à Chagnolet) | ✅ `scripts/planches/sankey-energie.py` (dispatch sur le bloc de l'extraction) |
