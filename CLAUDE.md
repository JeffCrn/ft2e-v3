...
| **Chantier du bloc SECTEURS de l'accueil** — **monté le 2026-08-25** : six arbitrages rendus (A10, cote 552 × 345, tirage du film au build, clichés réels © FT2E), coupe déployée en ligne, corpus de 44 clichés versé. Restent les validations FT2E (corpus, exclusions, artefacts IA) — § 5 à 8 du plan, prompt de suite en annexe B. La maquette est `docs/maquettes/ft2e-accueil-bloc-secteurs.html` — ⚠ page **bundlée**, son contenu vit dans un manifeste JSON, la lire brute ne montre que l'enveloppe | **`docs/superpowers/plans/2026-08-17-chantier-bloc-secteurs.md`** |
