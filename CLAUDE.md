...
- **Nomenclature** (`/references`) : liste tabulaire, pas de grille de cartes — **titre COURT** (celui de la planche, lu par `titreCourt()`), le titre long du frontmatter restant au `<h1>` de la fiche et au référencement — rang par **opacité du filet gauche 1 px** (livré 22 % / en cours 16 % / archive 12 %, champ `statut` des fiches) et **graisse de l'intitulé** (700/600/300), tout sur une page.
