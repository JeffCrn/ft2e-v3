...
- **Quatre des six articles SEO de lancement restent à écrire** — deux publiés le 2026-09-04 (RE2020 en logement, coordination SSI en cinquième catégorie). C’est le critère de sortie de Phase 4 qui ne dépend de personne d’autre. Le maillage du cocon sémantique, lui, EXISTE depuis la N26 : un article déclare ses `piliers` une seule fois au frontmatter, les onze pages piliers ramassent — **ne pas ajouter de champ symétrique `articles_lies`**, ce dessin a été écarté le 2026-09-04. ⚠ Six articles ne couvriront jamais onze piliers, et `seo-geo.md` en demande 3 à 5 par pilier : c’est structurel, à dire à FT2E plutôt qu’à laisser découvrir.
...
| **Chantier des SIX ARTICLES SEO de lancement — 2 sur 6 au 2026-09-04** (le seul critère de sortie de Phase 4 entièrement dans notre camp ; ⚠ le vrai chantier n’est pas « écrire six textes » mais « câbler six textes » — le maillage pilier → article n’existait PAS avant la N26, 4 des 11 piliers desservis contre 0 ; sujets arrêtés par `docs/17`, mais dits « à valider en cadrage » : les écrire n’est pas les valider ; prompt de la N27 en annexe A) | **`docs/superpowers/plans/2026-09-04-chantier-six-articles-seo.md`** |
