...
2 bis. **Illustre chaque fiche par une planche de schéma de principe** — un dessin FT2E composé à partir de sa propre matière technique, sans aucune géométrie d'ouvrage ni œuvre de tiers. **Chantier ouvert le 2026-08-12, 14 planches publiées sur 23** : `docs/superpowers/plans/2026-08-12-chantier-planches-references.md`.
