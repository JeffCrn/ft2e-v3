...
- **Monogramme** (`Logo.astro`) : cadre ouvert + flux débordant + lettres FT2E + signature mono. **Repris le 2026-09-11 sur demande FT2E** — approche du mot resserrée de 11 à 8 unités d’écart (amendement **A15**) et signature passée de « BUREAU D’ÉTUDES TECHNIQUES » à « BUREAU FLUIDES / ET THERMIQUE », **deux lignes justifiées sur l’empan du mot** (amendement **A16**). Le verrouillage reste 330 × 90. Versions `principal`/`inverse`/`valeur-unique`, forme `cadre` sous 180 px, hauteur min 28 px. Le débord ne se recadre jamais ; ni ombre ni contour.
