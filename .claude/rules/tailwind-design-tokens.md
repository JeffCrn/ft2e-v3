...
- Aucun parallax, aucun hover lift ; **un seul compteur existe sur tout le site** — les quatre chiffres du relevé de l'accueil (A14, une fois par chargement) ; `prefers-reduced-motion` partout (tout est posé d'emblée).
